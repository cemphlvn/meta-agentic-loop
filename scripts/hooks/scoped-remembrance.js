...
const HIERARCHY = {
  ...
  tactical: {
    level: 1,
    parent: 'system',
    children: ['orchestrator', 'librarian', 'ontological-researcher', 'epistemological-researcher', 'brand-builder', 'audit-master']
  },
  ...
  'audit-master': { level: 2, parent: 'tactical', children: ['security-auditor', 'quality-auditor', 'compliance-auditor', 'verification-agent'] },

  // Operational tier
  operational: {
    level: 1,
    parent: 'system',
    children: ['code-implementer', 'code-reviewer', 'code-simplifier', 'repo-strategist', 'security-auditor', 'quality-auditor', 'compliance-auditor', 'verification-agent']
  },
  ...
  // Audit team (operational)
  'security-auditor': { level: 2, parent: 'operational', children: [] },
  'quality-auditor': { level: 2, parent: 'operational', children: [] },
  'compliance-auditor': { level: 2, parent: 'operational', children: [] },
  'verification-agent': { level: 2, parent: 'operational', children: [] }
};
